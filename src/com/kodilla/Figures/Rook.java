...
public class Rook implements Figure  {
    ...
    private final Image whiteRook = new Image("file:resources/pawns/whiteRook.gif",80,80,true,true);
    private final Image blackRook = new Image("file:resources/pawns/blackRook.gif",80,80,true,true);
